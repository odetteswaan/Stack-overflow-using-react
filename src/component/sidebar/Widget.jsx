...
import pen from '../../assesst/pen.png'
import chat from '../../assesst/chat.png'
import blackLogo from '../../assesst/backlogo.png'
import WidgetTags from './Widgetstags'
...
export default function Widget() {
  return (
    <div>
    <div className='div'>
    <h4 className='heading4'>The Overflow Blog</h4>
      ...
      <h4 className='heading4'>Featured on Meta</h4>
      <div className="right-sidebar-div-1">
        <div className="right-sidebar-div-2">
      ...
      <h4 className='heading4'>Hot Meta Posts</h4>
      <div className="right-sidebar-div-1">
        <div className="right-sidebar-div-2">
          <p>38</p>
          <p>
